                ...
                <div class="recentOrders">
                    ...
                    if ($users) {
                        ...
                        foreach ($users as $user) {
                           ...
                           // Ajout du bouton de suppression et du formulaire de modification
                           echo "<td>";
                           echo "<button onclick='location.href=\"update.php" '>edit</button>";
                           echo "<form  id='udateform" . $user['id'] . "' style='display: none;' action='update.php' method='post'>";
                           echo "<input type='hidden' name='' value='"'>";
                           echo "<input type='submit' value='Confirm update'>";
                           echo "</form>";
                           echo "</td>";
